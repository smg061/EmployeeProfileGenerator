...
let separator = `<div class="w-100"></div>`; // this is an html to allow cols to wrap; it's conditionally added if there's more than 4 cards added
...
function createHTMLFromEmployeeCards(card) {
  ...
  <head>
    ...
    <div class="container">
      ...
      <p class="lead">This team profile was generated by EmployeeProfileGenerator</p>
    </div>
    </div>
